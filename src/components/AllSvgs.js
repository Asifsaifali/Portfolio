export const PowerBtn = (props) => {
    ...
    >
      <path 
          fill={props.fill}
      d="M56 3.7c-.8.3-12.8 11.8-26.7 25.6C10.9 47.7 3.9 55.2 3.4 57.5c-1.1 5.1-.6 8.4 2 12.8 3.2 5.4 46.3 48.3 49.9 49.6 7.4 2.8 15.8.2 19.7-6.1 2.5-4.1 2.7-12.3.4-15.8-.9-1.4-7.6-8.5-14.8-15.9L47.5 68.8l6.9 4.6 6.8 4.6h26.6c24.8 0 26.9.1 30.8 2.1 8.4 4 12.5 10.5 13.9 22.1 1.5 11.6 12.5 18.1 22.5 13 5.7-2.8 8-7.3 8-15.7 0-23-16.7-44.3-40.1-51.2-4.3-1.2-13-1.7-41.4-2.2-26-.4-34.3-.8-30-1.5 5.9-.8 6.2-1 15.4-10.1l9.5-9.3.3-5.8c.5-6.9-1.6-11.2-6.9-14.4C66.6 3.1 59.6 2.4 56 3.7z" />
    </svg>
    )
  }
